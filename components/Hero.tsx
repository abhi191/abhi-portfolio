...
const HeroIllustration: React.FC = () => {
  return (
    <svg width="250" height="200" viewBox="0 0 250 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-48 h-auto md:w-64">
    ...
    <section className="py-24 md:py-40">
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          <h1 className="text-5xl md:text-6xl font-extrabold leading-snug tracking-tighter">
            Hi, myself Abhinav
          </h1>
          <p className="text-lg md:text-xl text-brand-dark/80 max-w-lg leading-relaxed">
            A multi-disciplinary designer having strong technical expertise and hands on knowledge with 9+ years of domain experience in designing and developing for enterprise and consumer grade applications to create meaningful, clear, usable, and effective products.
Currently working as an Interaction Designer at Google
            </p>
        </div>
