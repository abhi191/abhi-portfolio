...
export const designVelocityAmplifiedProject: Project = {
  ...
  title: 'Design Velocity Amplified',
  description: 'Designing 94% Faster with AI-Driven Prototyping',
  metrics: [
  ...
  overview: "When working on the Feature Flags experience for SaaS Runtime, I faced a major bottleneck — the **CEL Expression Builder** we needed didn’t exist in our design system. Building it manually in Figma would have taken around three days. To move faster, I used an **AI-driven prototyping approach** I call *Design with Vibecoding*, leveraging Google AI Studio to create interactive prototypes in just **four hours** — a **94% reduction** in time.",
  details: [
    { label: 'Focus', value: 'AI in Design, Prototyping' },
    { label: 'Method', value: 'Vibecoding' },
    { label: 'Scope', value: 'DesignOps, UX Leadership' },
  ],
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'paragraph', content: "The main challenge was visualizing and validating a complex, logic-heavy component efficiently." },
        { type: 'list', style: 'unordered', items: [
            "No Figma component existed for the CEL builder",
            "Manual mocks couldn’t capture nested interactions or multiple logic paths",
            "Engineering bandwidth was limited for quick UI prototyping"
        ]},
    ...
    },
    {
        title: 'Impact',
        blocks: [
          { type: 'paragraph', content: "**3 days:** Estimated manual prototyping time (limited interactions) vs. **4 hours:** AI-generated (Vibecoded) prototype with all permutations." }
        ]
    },
    {
      ...
      blocks: [
        ...
        { type: 'heading', level: 3, content: '1. Created a simple split button.' },
        { type: 'image', src: '/images/projects/design-velocity-amplified/image 1.png', isExpandable: true },
        { type: 'heading', level: 3, content: '2. Used reference screenshots to show AI how I wanted it to behave.' },
        { type: 'image', src: '/images/projects/design-velocity-amplified/image 2.png', isExpandable: true },
        { type: 'heading', level: 3, content: '3. Added conditional logic with operators and values.' },
        { type: 'image', src: '/images/projects/design-velocity-amplified/image 3.png', isExpandable: true },
        { type: 'heading', level: 3, content: '4. Introduced AND/OR conditions to simulate real user flows.' },
        { type: 'image', src: '/images/projects/design-velocity-amplified/image 4.png', isExpandable: true },
        { type: 'heading', level: 3, content: '5. Expanded to nested grouped conditions and highlighted regions for AI to focus on.' },
        ...
        { type: 'heading', level: 3, content: '6. Added advanced options like “Copy, Edit, Delete” and default field values to improve iteration speed.' },
        { type: 'image', src: '/images/projects/design-velocity-amplified/image 7.png', isExpandable: true },
        { type: 'heading', level: 3, content: '7. Layered in more complex nested interactions to validate full logic coverage.' },
    ...
    },
    {
      ...
      blocks: [
        { type: 'list', style: 'ordered', items: [
            ...
            "Use clear, simple language and examples to communicate behavior."
        ]}
      ]
    },
    {
      title: 'Outcomes',
      blocks: [
        { type: 'paragraph', content: "When I shared the working prototype with PMs and engineers, they realized how complex the builder could get in real use. This insight led to immediate UX improvements:" },
        { type: 'list', style: 'unordered', items: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'paragraph', content: "To help other designers move faster, I documented my process and created internal resources:" },
        { type: 'list', style: 'unordered', items: [
            "A **Vibecoding Deployment Guide** for hosting prototypes on Google Cloud",
        ...
        { type: 'image', src: '/images/projects/design-velocity-amplified/Screenshot_2025-10-27_at_12.10.58_AM.png', isExpandable: true },
