...
export const saasRuntimePlaygroundProject: Project = {
  id: 99,
  slug: 'saas-runtime-playground',
  password: 'saas',
  company: 'Google Cloud (Playground)',
  ...
  title: 'SaaS Runtime - Playground V2',
  ...
  imageUrl: '/images/projects/saas-runtime/card-image.png',
  imagePosition: 'left',
  ...
  sections: [
      ...
      blocks: [
        { type: 'heading', level: 4, content: 'Objectives' },
        {
          type: 'list', style: 'ordered', items: [
            'Worked with UXR to design a research plan to understand 3P service producers needs and pain points.',
    ...
    },
    {
      ...
      blocks: [
        {
          type: 'video',
          url: 'https://www.youtube.com/watch?v=PVz_NKIXMUY',
          caption: 'View the launch of SaaS Runtime at Google Cloud Next conference in April 2025'
        }
      ]
    },
